...
```{R}
  ...
  mp.complete <- fread("/Users/Hutch/Desktop/MP.csv", header=TRUE)
...
```{r}
  ...
  # Remove year  columns for years 1960 - 2010
#remove col 3 so my code matches Ryba's code
#remove 2018:2020
  mp.2017<- mp.complete[,-c(5:45), with=F]
view(mp.2017)
#ncol(mp.2017)
mp.2017<- mp.2017[,-c(22:25), with=F]
#ncol(mp.2017)
mp.2017 <- mp.2017[,-c(3)]
ncol(mp.2017)
#view(mp.2017)
...
```{R}
  ...
  mp.ts <- gather(mp.2017, Year, "Value", 4:20)
#view(mp.ts)
